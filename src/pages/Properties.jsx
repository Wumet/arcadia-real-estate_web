...
function Properties() {
  return (
    <main className="py-4 sm:py-14 2xl:py-20">
      {/* search & filter */}
      <div className="rounded-xl border border-gray-300 w-5/6 mx-auto p-6">
        <input type="search" name="" id="" />
      </div>

      {/* properties */}
      <section className="py-6 sm:py-10 px-6 sm:px-20 xl:px-40 2xl:px-50 space-y-6 lg:space-y-12">
        <div>
      ...
      {/* cta */}
      <section className="py-6 sm:py-16 px-6 sm:px-28 xl:px-40 2xl:px-50 space-y-6 flex flex-col items-center">
        <H1
          title="Ready to Secure a Property?"
          label="Contact Us"
          textAlign="center"
          extraClass="!text-4xl sm:!text-[40px] 2xl:text-[54px]"
        />
