...
function Message() {
  return (
    <section className="py-14 sm:py-20 2xl:py-30 px-6 sm:pl-10 xl:pl-40 2xl:pl-50 space-y-8 sm:space-y-12 max-sm:flex-col-reverse flex items-center justify-center gap-10 md:gap-14 2xl:gap-20">
